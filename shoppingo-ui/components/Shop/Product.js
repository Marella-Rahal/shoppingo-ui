      ...
      <div
        className={
          router.asPath == `/productDetail/${router.query.productId}`
            ? "relative flex flex-col space-y-3 mr-5 pb-3 w-[250px] h-fit rounded-lg shadow-md shadow-shadowColor"
            : "relative flex flex-col space-y-3 my-5 sm:mx-3 pb-3 w-[250px] h-fit rounded-lg shadow-md shadow-shadowColor"
        }
      >
        {/* section 1 */}
        ...
        <div className="flex justify-between items-center px-3 h-[40px]">
          <button
            className="rounded-md bg-textColor hover:bg-[#050531] dark:bg-gradient-to-l dark:from-gradientFrom dark:to-gradientTo dark:hover:bg-gradient-to-b py-[3px] px-[17px]"
            onClick={() => {
              setRatingPopUp(true);
            }}
          >
